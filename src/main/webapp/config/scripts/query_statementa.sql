...
INSERT INTO `query_statementa` VALUES (135, 2, '2019-06-07 11:45:22', NULL, 'operation4Routine', b'0', b'1', 'list', '[max, myself, offset, thingTypeList]', 'from Progress progress where progress.team.leader=:myself and progress.team.thing.thingType in :thingTypeList\r\norder by progress.regDate desc', '带队的课程', 'listProgress4Course');
