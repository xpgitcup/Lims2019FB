...
<html>
    ...
    <body>
        ...
        <div id="show-teacher" class="content scaffold-show" role="main">
            ...
            <g:form id="${this.teacher.id}" controller="${params.controller}" action="delete" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" id="${this.teacher.id}" controller="${params.controller}">
