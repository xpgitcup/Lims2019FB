...
<html>
    ...
    <body>
        ...
        <div id="show-thing" class="content scaffold-show" role="main">
            ...
            <f:display bean="thing" />
            <g:form id="${this.thing.id}" controller="${params.controller}" action="delete" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" id="${this.thing.id}" controller="${params.controller}">
