...
<html>
    ...
    <body>
        <a href="#create-systemAttribute" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-systemAttribute" class="content scaffold-create" role="main">
            ...
            <g:form id="${this.systemAttribute.id}" action="save" controller="${params.controller}" method="POST">
                <fieldset class="form">
