...
<html>
    ...
    <body>
        ...
        <div id="show-personTitle" class="content scaffold-show" role="main">
            ...
            <g:form id="${this.personTitle.id}" controller="${params.controller}" action="delete" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" id="${this.personTitle.id}" controller="${params.controller}">
