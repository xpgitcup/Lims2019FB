...
<html>
    ...
    <body>
        <a href="#create-personTitle" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-personTitle" class="content scaffold-create" role="main">
            ...
            <g:form id="${this.personTitle.id}" action="save" controller="${params.controller}" method="POST">
                <fieldset class="form">
