...
<body>
<a href="#create-thingType" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<!--g:form resource="${this.thingType}" method="POST"-->
    <g:form id="${this.thingType?.id}" controller="operation4ThingType" action="save" method="POST">
        <fieldset class="form">
