...
<html>
    ...
    <body>
        ...
        <div id="show-plan" class="content scaffold-show" role="main">
            ...
            <f:display bean="plan" />
            <g:form id="${this.plan.id}" controller="${params.controller}" action="delete" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" id="${this.plan.id}" controller="${params.controller}">
