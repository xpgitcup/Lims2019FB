...
<html>
    ...
    <body>
        <a href="#create-progress" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-progress" class="content scaffold-create" role="main">
            ...
            <g:form id="${this.progress.id}" action="save" controller="${params.controller}" method="POST">
                <fieldset class="form">
                    <f:all bean="progress"/>
