...
<html>
    ...
    <body>
        <a href="#create-queryStatementA" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-queryStatementA" class="content scaffold-create" role="main">
            ...
            <g:form id="${this.queryStatementA.id}" action="save" controller="${params.controller}" method="POST">
                <fieldset class="form">
